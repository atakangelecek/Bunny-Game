...
vec3 kd = vec3(1, 0.8, 0.0);     // diffuse reflectance coefficient
vec3 ka = vec3(0.3, 0.25, 0.1);   // ambient reflectance coefficient
vec3 ks = vec3(0.9, 0.9, 0.6);   // specular reflectance coefficient
